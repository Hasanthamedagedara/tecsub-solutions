...
const DEFAULT_PRODUCTS: Product[] = [
    {
        id: "p-001", name: "Tecsub Recorder Pro License", category: "Software", price: 0, originalPrice: 49, rating: 4.9, reviews: 234,
    ...
    {
        id: "p-002", name: "Premium Logo Design Pack", category: "Design", price: 0, originalPrice: 35, rating: 4.7, reviews: 182,
    ...
    {
        id: "p-003", name: "Social Media Template Bundle", category: "Templates", price: 0, originalPrice: 25, rating: 4.8, reviews: 312,
    ...
    {
        id: "p-004", name: "AI Prompt Engineering Guide", category: "eBook", price: 0, originalPrice: 15, rating: 4.6, reviews: 156,
    ...
    {
        id: "p-005", name: "Website Starter Kit", category: "Development", price: 0, originalPrice: 75, rating: 4.9, reviews: 98,
    ...
    {
        id: "p-006", name: "YouTube Thumbnail Pack", category: "Design", price: 0, originalPrice: 20, rating: 4.5, reviews: 267,
    ...
    {
        id: "p-007", name: "Data Grab V5 Pro License", category: "Software", price: 0, originalPrice: 39, rating: 4.8, reviews: 143,
    ...
    {
        id: "p-008", name: "Coding Wallpaper Pack", category: "Media", price: 0, originalPrice: 10, rating: 4.4, reviews: 89,
    ...
    {
        id: "p-009", name: "Notion Business Template", category: "Productivity", price: 0, originalPrice: 29, rating: 4.7, reviews: 201,
    ...
    {
        id: "p-010", name: "Sound Effects Pro Pack", category: "Audio", price: 0, originalPrice: 18, rating: 4.6, reviews: 134,
    ...
    {
        id: "p-011", name: "VPN Ultra Annual Plan", category: "Service", price: 0, originalPrice: 60, rating: 4.8, reviews: 189,
    ...
    {
        id: "p-012", name: "Stock Photo Bundle", category: "Media", price: 0, originalPrice: 40, rating: 4.5, reviews: 76,
