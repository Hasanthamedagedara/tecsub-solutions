...
const DEFAULT_SOFTWARE: Software[] = [
    ...
    { id: "sw-002", name: "App Forge Studio", category: "Development", version: "v1.4.5", platform: "Windows / Linux", description: "Low-code mobile app builder for rapid prototyping and deployment.", icon: "🛠️", color: "#F97316", size: "120 MB", badge: "New" },
