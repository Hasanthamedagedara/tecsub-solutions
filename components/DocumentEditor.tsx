...
export default function DocumentEditor() {
    ...
    return (
        <div className="w-full flex justify-center gap-6 px-4">
            {/* Left Ad - Web Only */}
            <div className="hidden xl:flex flex-col pt-6 w-[160px] flex-shrink-0">
                <AdPlacement format="160x600" webOnly />
            </div>

            <div className="editor-interface max-w-5xl w-full flex flex-col items-center">
                {/* ─── Toolbar ─── */}
