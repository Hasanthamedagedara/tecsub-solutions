...
const sidebarItems: SidebarItem[] = [
    ...
    { icon: "🔥", label: "For You", href: "#discovery-feed" },
    ...
    { icon: "📚", label: "Books", href: "#content-sections" },
    { icon: "🖼️", label: "Images", href: "#content-sections" },
    { icon: "🎨", label: "Wallpapers", href: "#content-sections" },
    { icon: "🎓", label: "Courses", href: "/courses" },
    { icon: "⬇️", label: "Down Now", href: "#software" },
    { icon: "", label: "", href: "", type: "divider" },
    { icon: "", label: "More", href: "", type: "section-title" },
    { icon: "🌐", label: "Community", href: "#social" },
    { icon: "📩", label: "Contacts", href: "#social" },
    { icon: "ℹ️", label: "About", href: "/about" },
    { icon: "📝", label: "Feedback", href: "#social" },
