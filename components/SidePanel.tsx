...
const sidebarItems: SidebarItem[] = [
    ...
    { icon: "🔥", label: "Trending", href: "#recent-updates" },
    { icon: "", label: "", href: "", type: "divider" },
    { icon: "", label: "Explore", href: "", type: "section-title" },
    { icon: "🛠️", label: "Online Tools", href: "/tools" },
    { icon: "📦", label: "Software Hub", href: "#software" },
    { icon: "📰", label: "Tech News", href: "#news" },
    { icon: "🤖", label: "AI Lab", href: "#ai-lab" },
    { icon: "💡", label: "AI Prompts", href: "/prompts" },
    { icon: "🎓", label: "Courses", href: "/courses" },
    { icon: "📱", label: "Apps", href: "/apps" },
    { icon: "🛒", label: "Online Assets", href: "/assets" },
